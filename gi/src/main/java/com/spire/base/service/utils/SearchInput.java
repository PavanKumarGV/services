...
public class SearchInput implements Serializable {
	...
	return "SearchInput [searchQueryString=" + searchQueryString + ", freeSearchQueryString="
		+ freeSearchQueryString + ", searchAttributeMap=" + searchAttributeMap + ", customFields="
		+ customFields /*+ ", customFacets=" + customFacets*/ + "]";
    }
}
