...
public class SearchUtil {
	...
	// "(skill:java and skill:mysql AND skill:j2ee) AND (location:Bengalore
	// AND location:Mumbai)";
    ...
    /*
     * public static SearchInputRequest
     * getSearchInputBeanWithSkillAndExperienceFacet() { SearchInput searchInput
     * = new SearchInput();
     * 
     * String searchQueryString = "(skill:java and skill:MySQL)"; Map<String,
     * List<String>> searchAttributeMap = new HashMap<String, List<String>>();
     * 
     * List<String> skills = new ArrayList<String>(); skills.add("MySQL");
     * skills.add("java");
     * 
     * searchAttributeMap.put("skill", skills);
     * 
    ...
    /**
     * This method check if all array elements is in ascending order
     * @param data
     * @return
     */
    public static boolean isSortedInAscOrder(long[] data) {
    ...
    /**
     * This method check if all array elements is in descending order
     * @param data
     * @return
     */
    public static boolean isSortedInDscOrder(long[] data) {
	for (int i = 0; i < data.length - 1; i++) {
	    if (data[i] < data[i + 1]) {
		return false;
	    }
